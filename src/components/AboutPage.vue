<template>
    <div class="margin-bottom">
        ...
        <about-us v-bind:image="image" :paragraph1="paragraph1" :paragraph2="paragraph2"></about-us>
        <div class="container">
            <div class="row row-space pt-md-5">
                <div class="col-12 col-md-6 mr-3">
