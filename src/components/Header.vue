<template>
    <div class="container"> 
        <div class="row justify-content-between m-1 align-items-end ">
            ...
            <!--hamburger menu-->
            <button type="button" class="navbar-toggler collapsed  d-md-none" data-toggle="collapse" data-target="#navbarCollapse">
                ...
                <div class="main-menu collapse navbar-collapse" id="navbarCollapse" >
                    <ul class="navbar-nav main-navigation pt-2">
                        <li class="nav-item" v-for='(menu,index) in menues' :key="index">
                            <router-link class="nav-link pl-md-0 pr-md-4" :to="menu.link" :exact="menu.exact">{{menu.name}}</router-link>
                        </li>
                
                    <li class="hamburger-social-media nav-item d-md-none mt-2">
                        <a v-for="(media,index) in socialMedia" :key="index" :href="media.href" target="_blank" class="mr-1">
                            <svg 
                                :xmlns='xmlns' 
                                xmlns:xlink="http://www.w3.org/1999/xlink" 
                                width="35"
                                ...
                                <g>
                                    <g :transform="media.transform">
                                        <use fill="#dadada" :xlink:href="'#' + media.id" />
                                    </g>
                                </g>
                            </svg>
                        </a>
                    </li> <!--social media hamburger-->
                    </ul>
                </div>
            </nav>
        </div>
